...
class ModelDataExtractor:
    ...
    def load_model_data(self, model_num: int) -> Dict:
        ...
        print(f"  ✓ Found Model {model_num}: {filepath}")
...
class ComparisonPlotGenerator:
    ...
    def plot_a_performance_comparison(self):
        ...
        plt.close()
        print("✓ Generated Plot A: R² Comparison")
    ...
    def plot_d_cumulative_accuracy(self):
        ...
        if not plotted_any:
            print("⚠ Skipping Plot D: No valid data")
            plt.close()
            return
        ...
        plt.close()
        print("✓ Generated Plot D: Cumulative Accuracy Curve")
    ...
    def plot_e_tolerance_heatmap(self):
        ...
        if not models:
            print("⚠ Skipping Plot E: No valid data")
            plt.close()
            return
        ...
        plt.close()
        print("✓ Generated Plot E: Tolerance Heatmap")
    ...
    def plot_f_cv_boxplot(self):
        ...
        if not models:
            print("⚠ Skipping Plot F: No valid data")
            plt.close()
            return
        ...
        ax.set_ylabel('R² Score (Cross-Validation)', fontsize=12, fontweight='bold')
        ax.set_title('Cross-Validation Stability: R² Distribution Across Folds', 
                    fontsize=14, fontweight='bold')
        ax.grid(axis='y', alpha=0.3)
        ax.set_ylim([0, 1])
        ...
        plt.close()
        print("✓ Generated Plot F: CV Box Plot")
    ...
    def plot_h_living_setting_performance(self):
        ...
        if not models:
            print("⚠ Skipping Plot H: No valid data")
            plt.close()
            return
        ...
        plt.close()
        print("✓ Generated Plot H: Living Setting Performance")
    ...
    def plot_i_bias_heatmap(self):
        ...
        if not models:
            print("⚠ Skipping Plot I: No valid data")
            plt.close()
            return
        ...
        plt.close()
        print("✓ Generated Plot I: Bias Heatmap")
    ...
    def plot_b_multi_metric(self):
        ...
        if not models:
            print("⚠ Skipping Plot B: No valid data")
            plt.close()
            return
        
        # Normalize RMSE and MAE to 0-1 scale for comparison with R²
        ...
        bars1 = ax.bar(x - width, r2_values, width, label='R² (Test)', alpha=0.8)
        ...
        plt.close()
        print("✓ Generated Plot B: Multi-Metric Comparison")
    ...
    def plot_c_error_metrics(self):
        ...
        if not models:
            print("⚠ Skipping Plot C: No valid data")
            plt.close()
            return
        ...
        plt.close()
        print("✓ Generated Plot C: Error Metrics Comparison")
...
def main():
    ...
    if found_files:
        ...
        print("⚠ No renewcommand files found. Please ensure files are in the correct location.")
    ...
    print(f"\n✓ Successfully loaded data for {len(data)} models: {list(data.keys())}")
    print()
