...
"""
    ...
    def generate_summary_report(self):
        ...
        # Collect best model based on test R²
...
- **Test R²**: {best_model.metrics['test']['r2']:.4f}
...
- Test R²: {model.metrics['test']['r2']:.4f}
- Test RMSE: ${model.metrics['test']['rmse']:.2f}
- CV R² (mean ± std): {model.metrics.get('cv', {}).get('r2_mean', 'N/A'):.4f} ± {model.metrics.get('cv', {}).get('r2_std', 'N/A'):.4f}
"""
