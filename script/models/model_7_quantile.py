...
⚠️ RESEARCH ONLY - NOT REGULATORY COMPLIANT ⚠️
...
- Median (τ = 0.50) as primary model for single allocation
...
class Model7QuantileRegression(BaseiBudgetModel):
    ...
    ⚠️ REGULATORY WARNING: NOT COMPLIANT WITH F.S. 393.0662 ⚠️
    ...
    - Median (τ = 0.50) as primary estimate
    ...
    def __init__(self):
        ...
        self.quantile_performance = {}  # R² for each quantile
        ...
        logger.info("⚠️  NOT REGULATORY COMPLIANT ⚠️")
    ...
    def fit(self, X_train: np.ndarray, y_train: np.ndarray):
        ...
        for tau in self.quantiles:
            ...
            # Pseudo R² for quantile regression (different from OLS R²)
            ...
            # Null model: predict τ-th quantile
            ...
            logger.info(f"  Pseudo-R² = {pseudo_r2:.4f}")
        ...
        logger.info("\n" + "="*80)
        logger.info(f"PRIMARY MODEL: Median Regression (τ = {self.primary_quantile})")
        logger.info("="*80)
    ...
    def run_complete_pipeline(self, 
        ...
        logger.info("⚠️  RESEARCH ONLY - NOT REGULATORY COMPLIANT ⚠️")
        logger.info("="*80)
...
def main():
    ...
    print("="*80)
    print("\n⚠️  CRITICAL REGULATORY WARNING ⚠️")
    print("="*80)
