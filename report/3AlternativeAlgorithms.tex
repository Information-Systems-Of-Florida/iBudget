...
\input{models/model_2/model_2_renewcommands.tex}
\input{models/model_3/model_3_renewcommands.tex}
\input{models/model_4/model_4_renewcommands.tex}
...
\begin{itemize}
    ...
    \item Retains problematic outlier exclusion requirement
\end{itemize}
...
%\input{3Alternative-11-Consensus.tex}